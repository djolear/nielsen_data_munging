...
calories_per_qfahpd_health_fn <- function(year, products_master, qfahpd_main, qfahpd_secondary) {
  ...
  write_csv(qfahpd_health_calories_by_household_wide, paste0("/project/ourminsk/nielsen/data/data_exports/qfahpd_calories_sc_imputed_quarterly/qfahpd_health_calories_imputed_sc_by_household_quarterly_wide_", year, ".csv"))
