...
calories_per_tfp_fn <- function(year, products_master, qfahpd_main, qfahpd_secondary) {
  ...
  write_csv(tfp_calories_by_household_wide, paste0("/project/ourminsk/nielsen/data/data_exports/tfp_calories_sc_imputed_quarterly/tfp_calories_imputed_sc_by_household_quarterly_wide_", year, ".csv"))
