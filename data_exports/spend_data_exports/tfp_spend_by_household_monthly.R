...
tfp_spend_by_household_fn <- function(niel_df, year) {
  ...
  write_csv(tfp_spend_by_household_wide, paste0("/project/ourminsk/nielsen/data/data_exports/tfp_spend_monthly/tfp_spend_by_household_monthly_wide_", year, ".csv"))
