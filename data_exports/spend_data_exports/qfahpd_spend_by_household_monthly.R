...
foodgroup_spend_by_household_fn <- function(niel_df, year) {
  ...
  foodgroup_spend_by_household <-
    foodgroup_spending_data %>% 
    group_by(household_code, foodgroup_i, month) %>% 
    summarise(
  ...
  write_csv(foodgroup_spend_by_household_wide, paste0("/project/ourminsk/nielsen/data/data_exports/qfahpd_spend_monthly/foodgroup_spend_by_household_monthly_wide_", year, ".csv"))
