...
qfahpd_health_spend_by_household_fn <- function(niel_df, year) {
  ...
  write_csv(qfahpd_health_spend_by_household_wide, paste0("/project/ourminsk/nielsen/data/data_exports/qfahpd_spend_monthly/qfahpd_health_spend_by_household_monthly_wide_", year, ".csv"))
