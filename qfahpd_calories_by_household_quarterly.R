...
source("/home/djolear/nielsen/bind_nielsen_to_label_insight_imputed_fn.R")
...
calories_per_qfahpd_health_fn <- function(year, products_master, qfahpd_main, qfahpd_secondary) {
  ...
  write_csv(qfahpd_health_calories_by_household_wide, paste0("/home/djolear/nielsen/nielsen_data_output/qfahpd_health_calories_imputed_sc_by_household_quarterly_wide_", year, ".csv"))
...
products_master <- 
  readr::read_csv("/home/djolear/nielsen/products_master_imputed_calories_servings_conversion.csv")
